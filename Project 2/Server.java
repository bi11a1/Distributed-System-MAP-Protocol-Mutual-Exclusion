...
class ClientHandler extends Thread
{
	...
	public void run()
	{
		while (true)
		{
			...
			// Wait for sometimes until the server is completely ready
			while (MutualExclusion.getNodeStatus() != true) {
				MutualExclusion.waitFor(ProtocolConfig.retryDelayMS+1);
			}

			MutualExclusion.HandleServerRequest(receivedMsg);
		}
	}
}
